<script src="<?php echo plugins_url('Js/jquery-2.1.1.min.js', __FILE__); ?>"  type='text/javascript'  /></script>
...
?>
   ...
   <div id="clearsale-dash" class="container-fluid">
            ...
            <div class="row bgm-white" style="margin:0 0px 50px 0">
                ...
                <div id="lastorders" class="col-xs-12 col-md-12 col-sm-12" style="padding:0">
