...
function BindSLA() {
    ...
    jQuery.ajax(
	{
	    ...
	    if (!isUpdate || SLAChart.data == null) {
...
function MountTableLastOrders(LastOrders) {
    ...
    lastOrderCanceled = 0;
		...
		if(prefix == 'https://sandbox.clearsale.com.br/')
		{
			urlRaiz = 'https://sandbox.clear.sale/';
		}else
		{
			urlRaiz = 'https://app.clear.sale/';
		}
    ...
    jQuery.each(LastOrders, function (i, data) {
        ...
        html += "<td>" + "<a href=\"" + urlRaiz + "Order/DetailByOrderId/"+ data.ClientOrderId + "\" target=\"_blank\" >" + data.ClientOrderId + "</a></td>";
        html += "<td>" + "$ " + data.TotalOrderValue + "</td>";
