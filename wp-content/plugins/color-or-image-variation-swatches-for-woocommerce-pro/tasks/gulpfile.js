...
gulp.task('update-scripts', [], function () {
	console.log("Moving Scripts from vendor to Pro version");

	//Copy js from vendor to pro version
	gulp.src("../vendor/algoritmika/color-or-image-variation-swatches-for-woocommerce/assets/dist/frontend/js/alg-wc-civs.js")
	    .pipe(gulp.dest(dirs.frontend.src.js));

	//Copy css from vendor to pro version
	gulp.src("../vendor/algoritmika/color-or-image-variation-swatches-for-woocommerce/assets/dist/frontend/css/alg-wc-civs.css")
	    .pipe(rename("alg-wc-civs.scss"))
	    .pipe(gulp.dest(dirs.frontend.src.sass + '/alg-wc-civs/'));
});
