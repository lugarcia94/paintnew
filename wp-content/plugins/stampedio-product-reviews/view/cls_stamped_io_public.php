...
class Woo_stamped_public {
    ...
    public static function Woo_stamped_review_box() {
        ...
        echo sprintf('<div id="stamped-main-widget" class="stamped stamped-main-widget" data-product-id="%d" data-product-sku="%s" data-name="%s" data-url="%s" data-image-url="%s">%s</div>', $product_id, $product_sku, $product_title, get_the_permalink(), $img, $content); // data-description="%s" / $desc
    }
    ...
    public static function Woo_stamped_review_badge() {
        ...
        echo sprintf('<div class="stamped-product-reviews-badge" data-id="%d" data-product-sku="%s" data-url="%s"></div>', $product_id, $product_sku, get_the_permalink());
    }
    ...
    public static function Woo_stamped_review_badge_single_product() {
        ...
        echo sprintf('<span class="stamped-product-reviews-badge stamped-main-badge" data-id="%d" data-product-sku="%s" data-url="%s"></span>', $product_id, $product_sku, get_the_permalink());
        echo sprintf('<span class="stamped-product-reviews-badge stamped-main-badge" data-id="%d" data-product-sku="%s" data-url="%s" data-type="qna" style="display:none;"></span>', $product_id, $product_sku, get_the_permalink());
    }
